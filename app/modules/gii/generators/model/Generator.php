...
class Generator extends \yii\gii\Generator
{
    ...
    public $db = 'db';
    public $ns = 'app\plugins\pluginid\models';
    public $tableName;
    public $modelClass;
    ...
    public $generateDropdownListFields = 'status';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['ns', 'queryNs','generateDropdownListFields'], 'filter', 'filter' => function ($value) { return trim($value, '\\'); }],
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'generateDropdownListFields' => 'Generate Dropdown list',
        ]);
    }
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            'ns' => 'This is the namespace of the ActiveRecord class to be generated, replace pluginid ,e.g., <code>app\plugins\pluginid\models</code>',
            ...
            'generateDropdownListFields' => '生成下拉列表的静态方法,多个字段用逗号分开',
    ...
    {
        return array_merge(parent::stickyAttributes(), ['ns', 'db', 'baseClass', 'generateRelations', 'generateLabelsFromComments', 'queryNs', 'queryBaseClass','generateDropdownListFields']);
    }
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $params = [
                ...
                'dropdownListFields'=>$this->generateDropdownList(),
    ...
    {
        return explode(",",$this->generateDropdownListFields);
    }
}
